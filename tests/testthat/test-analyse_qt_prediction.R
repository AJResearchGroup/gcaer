test_that("analyse_qt_prediction", {
  ...
  datadir <-         "/home/richel/GitHubs/nsphs_ml_qt/issues/richel_issue_141/richel_issue_140/home/richel/sim_data_1_richel_issue_140"
  trainedmodeldir <- "/home/richel/GitHubs/nsphs_ml_qt/issues/richel_issue_141/richel_issue_140/home/richel/sim_data_1_richel_issue_140_ae"
  unique_id <- "richel_issue_141"

  png_filename <- paste0("~/", unique_id, ".png")
  csv_filename <- paste0("~/", unique_id, ".csv")
