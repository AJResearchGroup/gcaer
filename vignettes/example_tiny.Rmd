...
```{r gcae_options}
# We will use the local Python, instead of a Conda environment
...
```{r gcae_setup}
gcae_setup <- create_test_gcae_setup(superpops = get_gcaer_filename("gcae_input_files_1_labels.csv"))
gcae_setup
```
