 ...
 * `trainedmodelname`: ?name of the trained model
...
```{r model_id}
if (good_to_go) {
  model_filename <- get_gcae_model_filename(gcae_setup)
...
```{r train_opts_id}
if (good_to_go) {
  train_opts_filename <- get_gcae_train_opts_filename(gcae_setup)
...
```{r data_opts_id}
if (good_to_go) {
  data_opts_filename <- get_gcae_data_opts_filename(gcae_setup)
...
```{r data_opts_id}
if (good_to_go) {
  pheno_model_id_filename <- get_gcae_pheno_model_filename(gcae_setup)
