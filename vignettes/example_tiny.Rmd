...
```{r parse_train_filenames,cache=TRUE}
if (good_to_go) {
...
if (good_to_go) {
  ...
  # losses_from_project.csv
  parse_project_files(project_filenames)
}
```
...
if (good_to_go) {
  ...
  testthat::expect_equal(length(pdf_plot_filenames), epochs + 7)
}
```
