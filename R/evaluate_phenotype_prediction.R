...
evaluate_phenotype_prediction <- function(
  ...
  testthat::expect_true(dir.exists(gcae_experiment_params$gcae_setup$trainedmodeldir))
  ...
  # )
  # full_phe_table$normalized_true_phenotype <-
  #   normalized_values$normalized_true_values
  # full_phe_table$normalized_predicted_phenotype <-
  ...
  #
  # true_values_prediction_quality_plot <- ggplot2::ggplot(
  #   full_phe_table,
  ...
  #
  # # Normalized values
  # x_axis_min <- min(0.0, min(full_phe_table$normalized_true_phenotype))
  # x_axis_max <- max(0.0, max(full_phe_table$normalized_true_phenotype))
  # y_axis_min <- min(0.0, min(full_phe_table$normalized_predicted_phenotype))
  # y_axis_max <- max(0.0, max(full_phe_table$normalized_predicted_phenotype))
  #
  # normalized_values_prediction_quality_plot <- ggplot2::ggplot(
  #   full_phe_table,
  #   ggplot2::aes(x = normalized_true_phenotype, y = normalized_predicted_phenotype)
  # ) + ggplot2::geom_abline(slope = 1, intercept = 0, lty = "dashed") +
  #   ggplot2::geom_point() +
  #   ggplot2::scale_x_continuous(limits = c(x_axis_min, x_axis_max)) +
  #   ggplot2::scale_y_continuous(limits = c(y_axis_min, y_axis_max))
