...
create_test_gcae_experiment_results <- function() { # nolint indeed a long function name
  list(
    score_per_pop_table
      = gcaer::create_test_score_per_pop_table(),
    scores_table
      = gcaer::create_test_scores_table(),
    ...
    nmse_in_time_table
      = gcaer::create_test_nmse_in_time_table(),
    r_squared_in_time_table
      = gcaer::create_test_r_squared_in_time_table(),
    train_times_table
      = gcaer::create_test_train_times_table(),
